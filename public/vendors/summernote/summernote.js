    ...
    var Renderer = function () {
        ...
        var tplDialogInfo = {
            image: function (lang, options) {
                ...
                var body = '<div class="fileinput fileinput-new note-group-select-from-files" data-provides="fileinput">' +
                    '<span class="btn btn-default btn-file">' +
                    '<span class="fileinput-new">' + lang.image.selectFromFiles + '</span>' +
                    '<span class="fileinput-exists">' + lang.image.selectFromFiles + '</span>' +
                    ...
                    '<div class="fg-line"><input class="note-image-url form-control span12" placeholder="eg: http://abc.com/123.png" type="text" /></div>' +
                    '</div>';
            ...
            link: function (lang, options) {
                var body = '<div class="form-group row-fluid">' +
                    ...
                    '<div class="fg-line"><input class="note-link-text form-control span12" placeholder="eg: Click here..." type="text" /></div>' +
                    '</div>' +
                    '<div class="form-group row-fluid">' +
                    '<label>' + lang.link.url + '</label>' +
                    '<div class="fg-line"><input class="note-link-url form-control span12" placeholder="eg: http://google.com" type="text" /></div>' +
                    '</div>' +
                    (!options.disableLinkTarget ?
                            '<div class="checkbox">' +
                            '<label>' + '<input type="checkbox" checked> <i class="input-helper"></i>' +
